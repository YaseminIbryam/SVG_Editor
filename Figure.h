...
* @details Обединява общите характеристики и поведение на всички SVG фигури.
*/
class Figure {
protected:
...
public:
	...
	*/
	...
	/**
	* @brief Записва фигурата в изходен поток във формат SVG.
	* @param out Изходният поток, в който ще се записват данните.
	*/
	virtual void save(std::ostream& out) const = 0;

	/**
	 * @brief Връща типа на фигурата като низ.
	 * @return std::string Името на типа на фигурата.
	 */
